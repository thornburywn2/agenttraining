            ...
            <div id="patterns-panel" role="tabpanel" aria-labelledby="patterns-tab">
              ...
              <div className="prose prose-lg max-w-none">
                ...
                <div className="mb-8">
                  ...
                  {/* Pattern 2 */}
                  <div className="bg-white dark:bg-gray-800 border-2 border-indigo-300 dark:border-indigo-600 rounded-lg p-6 mb-4">
                  ...
                  {/* Pattern 5 */}
                  <div className="bg-white dark:bg-gray-800 border-2 border-pink-300 dark:border-pink-600 rounded-lg p-6 mb-4">
                ...
                <div className="mb-8">
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    <div className="bg-red-50 dark:bg-red-900/20 border-2 border-red-300 dark:border-red-600 dark:border-red-600 rounded-lg p-4">
